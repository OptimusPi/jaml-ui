...
export interface Entity { name: string; pos: Pos; animated?: boolean; }

export const jokers: Entity[] = [
...
export const jokerFaces: Entity[] = [
    {
        "name" : "Hologram",
        "pos" : { "x": 2, "y": 9 },
        "animated" : true
...
export const consumablesFaces: Entity[] = [
    {
        "name" : "The Soul",
        "pos" : { "x": 0, "y": 1 },
        "animated" : true
...
export const boosterPacks: Entity[] = [
...
export const tarotsAndPlanets: Entity[] = [
...
export const editionMap: Record<string, number> = {
    "Foil": 1,
    "Holographic": 2,
    "Polychrome": 3
};
export const stickerMap: Record<string, Pos> = {
    "Eternal": { x: 0, y: 0 },
    "Perishable": { x: 0, y: 2 },
    "Rental": { x: 1, y: 2 }
};
...
export const blinds: string[] = ['Small Blind', 'Big Blind', 'Boss Blind'];
export const blindsCamelCase = ['smallBlind', 'bigBlind', 'bossBlind'];
export const SeedsWithLegendary: Array<string> = [
    "HPR8Q7K",
    "5YVHAEP",
    "8QBRTPD",
    "9Q2HBUB",
...
export const popularSeeds: Array<string> =[
    "U8RJYV6N",
    '7LB2WVPK',
    'PHQ8P93R',
    '8Q47WV6K',
