...
function JamlIde() {
  ...
  return (
    <div ref={rootRef} style={{
      ...
      {/* Tab strip — red JimboButtons, JimboUI canon */}
      <div style={{
        ...
        {[['visual','Visual'], ['yaml','.jaml']].map(([k,l]) => (
          <div key={k} style={{ flex: 1, opacity: tab === k ? 1 : 0.55 }}>
            <button
              className="j-btn j-btn--red j-btn--md j-btn--full"
              onClick={() => setTab(k)}
              style={{ width: '100%' }}
            >
              <div className="j-btn__face">
                <span className="j-text j-text--sm">{l}</span>
              </div>
            </button>
          </div>
        ))}
      ...
      <div style={{
        ...
        <button className="j-btn j-btn--green j-btn--md j-btn--full" style={{ width: '100%' }}>
          <div className="j-btn__face">
            <span className="j-text j-text--sm">Save</span>
          </div>
        </button>
        <button className="j-btn j-btn--orange j-btn--md j-btn--full" style={{ width: '100%' }}>
          <div className="j-btn__face">
            <span className="j-text j-text--sm">Back</span>
          </div>
        </button>
      </div>
