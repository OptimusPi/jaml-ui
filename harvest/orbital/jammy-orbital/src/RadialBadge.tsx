...
// Excavated from JAMMY (`components/jimbo-ui/RadialNavigation/RadialBadge.tsx`).
...
export type RadialBadgeState = "loading" | "success" | "error";
 ...
 *
 * Visually matches RadialButton but renders as a `<div role="status">` with no
 * click handler — so a capability light in the orbit is never mistaken for a
 * button, by sighted users or by screen readers.
 */
