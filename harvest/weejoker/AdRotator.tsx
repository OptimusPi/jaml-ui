...
export function AdRotator({ onOpenWisdom, onOpenLeaderboard, topScore, isLocked }: AdProps) {
    ...
    return (
        <button
            onClick={handleClick}
            className="w-full relative overflow-hidden ad-rotator-button rounded-[4px] border-2 border-[#333] p-1 px-3 flex flex-row items-center justify-between gap-3 min-h-[44px] bg-[#111] shadow-[0_4px_0_#000] active:translate-y-[2px]"
        >
